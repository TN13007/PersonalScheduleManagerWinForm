...
{
    public partial class FastMeeting : Form
    {
        ...
        private void ApplyGoogleCalendarTheme()
        {
            ...
            this.MinimumSize = new Size(450, 530);
            ...
            txtNotificationTime.Height = 28;

            // Placeholders
            SetPlaceholder(txtTitle, "Nhập tiêu đề lịch hẹn...");
            SetPlaceholder(txtStartTime, "HH:mm");
            SetPlaceholder(txtEndTime, "HH:mm");
            SetPlaceholder(txtNotificationTime, "HH:mm");
        ...
        private void SetupUXEnhancements()
        {
            ...
            toolTip.SetToolTip(txtTitle, "Nhập tiêu đề cho lịch hẹn");
            ...
            toolTip.SetToolTip(dtpNotificationDate, "Chọn ngày thông báo");
            toolTip.SetToolTip(txtNotificationTime, "Nhập giờ thông báo (VD: 08:00)");
            toolTip.SetToolTip(rdoImportant, "Đánh dấu lịch hẹn quan trọng");
            toolTip.SetToolTip(rdoNormal, "Lịch hẹn bình thường");
            toolTip.SetToolTip(btnAdd, "Thêm lịch hẹn mới (Ctrl+S)");
        ...
        private void SetTabOrder()
        {
            ...
            dtpNotificationDate.TabIndex = tabIndex++;
            txtNotificationTime.TabIndex = tabIndex++;
