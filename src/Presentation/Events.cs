...
namespace Presentation
{
    public partial class Events : Form
    {
        ...
        private void ApplyGoogleCalendarTheme()
        {
            ...
            this.MinimumSize = new Size(450, 680);
            ...
            // Placeholders
            SetPlaceholder(txtTitle, "Nhập tiêu đề sự kiện...");
            SetPlaceholder(txtLocation, "Nhập địa điểm...");
            SetPlaceholder(txtStartTime, "HH:mm");
            SetPlaceholder(txtEndTime, "HH:mm");
            SetPlaceholder(txtDescription, "Mô tả chi tiết sự kiện...");
        ...
        private void SetupUXEnhancements()
        {
            ...
            toolTip.SetToolTip(txtTitle, "Nhập tiêu đề cho sự kiện");
            toolTip.SetToolTip(txtLocation, "Nhập địa điểm tổ chức");
            ...
            toolTip.SetToolTip(txtDescription, "Mô tả chi tiết về sự kiện");
            toolTip.SetToolTip(rdoImportant, "Đánh dấu sự kiện quan trọng");
            toolTip.SetToolTip(rdoNormal, "Sự kiện bình thường");
            toolTip.SetToolTip(btnAdd, "Thêm sự kiện mới (Ctrl+S)");
